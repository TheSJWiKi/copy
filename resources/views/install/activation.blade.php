                ...
                <div class="col-md-6 col-sm-12">   
                    ...
                    <div class="card overflow-hidden border-0 special-shadow">	
                        ...
                        <div class="card-body">                                                  
                            ...
                            <h3 class="text-center font-weight-bold fs-16 mb-4 mt-3">{{ __('License Activation') }} | <a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a></h3>
